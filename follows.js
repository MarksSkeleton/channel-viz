(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'ALo80NcMxsaXQeY9LvdFsOGHZ8yW3ZuYMBQl1oUVil6r5l5D', // Unique master Xively API key to be used as a default
		defaultFeeds	= [232643814], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Arduino Heizung', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
